...
| Canonical transcript | retain until user deletes; encrypt and protect with RLS |
...
- OpenAI, ElevenLabs, and Supabase service keys are server-only.
- Use short-lived ElevenLabs conversation tokens.
