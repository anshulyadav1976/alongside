...
Build the reliable technical spine: voice/session integration, OpenAI processing, Supabase schema, temporal memory, graph APIs, support/check-in policy, safety, and backend tests.
...
- Verify ElevenLabs webhook signatures using raw body.
- Use idempotency for webhook and processing routes.
- Persist OpenAI canonical transcript; delete raw audio.
